...
**Wat heb ik geleerd?** vandaag nog niet veel geleerd omdat het nu vooral veel ideation is.

## wat ik morgen ga doen?
morgen ga ik beginnen met code in mijn website zetten en de 1e curses doen



## dag 2 04/02/2026(met alexia)
### wat heb ik gedaan en hoeland duurde het?
cursessen in scroll animations en same document view transitions dit heeft 2 uur gekost. Daarna data uit de API gehaald dit heeft 1 uur geduurt omdat ik vergeten was om de functie aan te spreken.
### wat heb ik geleerd?
basis van keyframes en wat mogelijk is met view transitions.
